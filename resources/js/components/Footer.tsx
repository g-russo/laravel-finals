        ...
        <footer id="contact" className="bg-gray-900 text-white py-16">
            <div className="container mx-auto px-4 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-300 mb-6 max-w-md">
                            Your gateway to luxury and relaxation. Experience unparalleled hospitality in our tropical paradise where every detail is crafted for your perfect getaway.
                        </p>
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 mb-4">Subscribe to receive exclusive offers and updates</p>
                        <form className="flex">
                            <input
                                type="email"
                                placeholder="Your email address"
                                className="flex-1 px-4 py-2 rounded-l-full text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-600"
                            />
                            <button
                                type="submit"
                                className="bg-orange-600 text-white px-6 py-2 rounded-r-full hover:bg-orange-700 transition-colors duration-300"
                            >
                                Subscribe
                            </button>
                        </form>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
                    <p>&copy; 2025 Resort. All rights reserved. Built with excellence.</p>
                </div>
            </div>
        </footer>
    );

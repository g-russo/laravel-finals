...
export default function CreateAccommodation() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create New Accommodation" />
            {/* Bootstrap Icons CDN */}
            <link 
                rel="stylesheet" 
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-0.5">
                                        Add a new room, suite, or villa to your resort
                                    </p>
                                </div>
                            </div>
                            <Link
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
                                ...
                                <div className="p-6 space-y-6">
                                    ...
                                    <div>
                                        <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">
                                            <i className="bi bi-image mr-1"></i>Accommodation Image (Optional)
                                        </label>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {imagePreview && (
                                                <div className="relative">
                                                    ...
                                                    <div className="mt-2 text-xs text-gray-500 flex items-center">
                                                        <i className="bi bi-check-circle text-green-500 mr-1"></i>
                                            ...
                                            <div className="text-xs text-gray-500 bg-blue-50 p-3 rounded-lg">
                                                ...
                                                <strong>Tip:</strong> Use high-quality images that showcase your accommodation's best features. Recommended size: 1200x800 pixels.
                                            </div>
                                        </div>
                            ...
                            {/* Preview Card */}
                            {(data.accommodation_name || data.description || data.capacity || data.price_per_night || data.image) && (
                                <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
                                    <div className="px-6 py-5 border-b border-gray-100">
                                        <div className="flex items-center">
                                        ...
                                        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                                            ...
                                            <div className="bg-blue-50 px-4 py-3 border-t border-gray-200">
                                                <div className="flex items-center text-xs text-blue-700">
                                                    ...
                                                    <span>This is how your accommodation will appear in the main listing table</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
